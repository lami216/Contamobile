...
const capabilityLabels:Record<Capability,{ar:string;fr:string}>={
  ...
  'customers.view':{ar:'عرض العملاء',fr:'Voir les clients'},'customers.create':{ar:'إضافة العملاء',fr:'Ajouter des clients'},'customers.edit':{ar:'تعديل العملاء والتسويات',fr:'Modifier clients et règlements'},'customers.delete':{ar:'أرشفة العملاء',fr:'Archiver les clients'},'customers.collect':{ar:'تحصيل من العملاء',fr:'Encaisser les clients'},
  'suppliers.view':{ar:'عرض الموردين',fr:'Voir les fournisseurs'},'suppliers.create':{ar:'إضافة الموردين',fr:'Ajouter des fournisseurs'},'suppliers.edit':{ar:'تعديل الموردين والتسويات',fr:'Modifier fournisseurs et règlements'},'suppliers.delete':{ar:'أرشفة الموردين',fr:'Archiver les fournisseurs'},'suppliers.pay':{ar:'الدفع للموردين',fr:'Payer les fournisseurs'},
