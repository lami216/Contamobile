...
export interface DocumentRecord { id: string; number: string; sequence: number | null; kind: DocumentKind; status: DocumentStatus; partyId: string | null; partyName: string | null; warehouseId: string | null; warehouseName: string | null; destinationWarehouseId: string | null; destinationWarehouseName: string | null; paymentMethod: string | null; fromAccountId?: string | null; toAccountId?: string | null; accountAdjustmentDirection?: 'deposit' | 'withdrawal' | null; note?: string | null; title: string | null; total: number; dueTotal: number; paidTotal: number; cashAmount: number; partyCashDirection: 'receive' | 'pay' | null; partyBalanceBefore: number | null; partyBalanceDelta: number | null; partyBalanceAfter: number | null; businessDate: string | null; dailySequence: number | null; pricingMode: PricingMode | null; occurredAt: string; updatedAt: string | null; revision: number; voidedAt: string | null; lines: DocumentLine[]; }
