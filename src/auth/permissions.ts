export const CAPABILITIES = [
  ...
  'warehouses.view','warehouses.create','warehouses.edit','warehouses.delete','warehouses.inventory.view','warehouses.transfer','warehouses.transfer.edit','warehouses.transfer.delete','warehouses.adjust','warehouses.adjust.edit','warehouses.adjust.delete',
  'banks.view','banks.create','banks.edit','banks.delete','banks.movements.view','banks.transfer','banks.transfer.edit','banks.transfer.delete','banks.deposit_withdraw','banks.deposit_withdraw.edit','banks.deposit_withdraw.delete','banks.balance_correct','banks.balance_correct.edit','banks.balance_correct.delete',
...
const prerequisites: Partial<Record<Capability, readonly Capability[]>> = {
  ...
  'customers.edit':['customers.view'],'customers.delete':['customers.view'],'customers.collect.edit':['customers.view'],'customers.collect.delete':['customers.view'],
  'suppliers.edit':['suppliers.view'],'suppliers.delete':['suppliers.view'],'suppliers.pay.edit':['suppliers.view'],'suppliers.pay.delete':['suppliers.view'],
  'warehouses.edit':['warehouses.view'],'warehouses.delete':['warehouses.view'],'warehouses.transfer.edit':['warehouses.transfer'],'warehouses.transfer.delete':['warehouses.transfer'],'warehouses.adjust.edit':['warehouses.adjust'],'warehouses.adjust.delete':['warehouses.adjust'],
  'banks.edit':['banks.view'],'banks.delete':['banks.view'],'banks.transfer.edit':['banks.view'],'banks.transfer.delete':['banks.view'],'banks.deposit_withdraw.edit':['banks.view'],'banks.deposit_withdraw.delete':['banks.view'],'banks.balance_correct':['banks.view'],'banks.balance_correct.edit':['banks.view'],'banks.balance_correct.delete':['banks.view'],
